...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: `${parseFloat(stats.chiffreAffaires).toFixed(2)} MAD`,
      icon: TrendingUp,
      color: 'bg-indigo-500',
            ...
            <div>
              ...
              {dashboardData?.montantEnRetard && (
                <p className="text-xs text-red-600 mt-1">
                  {parseFloat(dashboardData.montantEnRetard).toFixed(2)} MAD
                </p>
              )}
            </div>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={caParMoisData}>
              ...
              <Tooltip 
                ...
                formatter={(value) => [`${parseFloat(value).toFixed(2)} MAD`, 'CA']}
              />
              <Area 
                type="monotone" 
                dataKey="ca" 
