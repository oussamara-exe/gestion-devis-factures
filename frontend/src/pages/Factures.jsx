                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-3 flex-wrap">
                      ...
                      <span className="text-lg font-bold text-primary-600">
                        {parseFloat(facture.montantTtc || 0).toFixed(2)} MAD TTC
                      </span>
                  ...
                  >
                    ...
                    {produits.map(p => (
                      <option key={p.id} value={String(p.id)}>
                        {p.nom} - {parseFloat(p.prixUnitaire || 0).toFixed(2)} MAD 
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-600 space-y-1">
                              <div>
                                {quantite} x {prixUnitaire.toFixed(2)} MAD = <strong>{montantHt.toFixed(2)} MAD HT</strong>
                              </div>
                              <div className="text-xs text-gray-500">
                                TVA ({tauxTva}%): {montantTva.toFixed(2)} MAD | <strong>TTC: {montantTtc.toFixed(2)} MAD</strong>
                              </div>
                            </div>
                          </div>
                          <button
                    ...
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-between pt-2 border-t border-blue-300">
                          ...
                          <span className="font-bold text-lg text-primary-600">{totalTtc.toFixed(2)} MAD</span>
                        </div>
                      </div>
                    </div>
                  );
                        ...
                        <div key={index} className="p-3 bg-gray-50 rounded-lg">
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-gray-600 space-y-1">
                                <div>
                                  Quantité: {detail.quantite} x {parseFloat(detail.prixUnitaire || 0).toFixed(2)} MAD
                                </div>
                                <div>
                                  TVA: {parseFloat(detail.tauxTva || 0).toFixed(2)}%
                                </div>
                                <div className="flex gap-4 mt-2">
                                  <span>HT: <strong>{parseFloat(detail.montantHt || 0).toFixed(2)} MAD</strong></span>
                                  <span>TVA: <strong>{parseFloat(detail.montantTva || 0).toFixed(2)} MAD</strong></span>
                                  <span>TTC: <strong className="text-primary-600">{parseFloat(detail.montantTtc || 0).toFixed(2)} MAD</strong></span>
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <div className="border-t pt-4">
                <div className="flex justify-end space-x-4 text-right">
                  <div>
                    ...
                    <p className="text-lg font-semibold">{parseFloat(selectedFacture.montantHt || 0).toFixed(2)} MAD</p>
                  </div>
                  <div>
                    <label className="text-sm text-gray-600">Total TVA</label>
                    <p className="text-lg font-semibold">{parseFloat(selectedFacture.montantTva || 0).toFixed(2)} MAD</p>
                  </div>
                  <div>
                    <label className="text-sm text-gray-600">Total TTC</label>
                    <p className="text-2xl font-bold text-primary-600">{parseFloat(selectedFacture.montantTtc || 0).toFixed(2)} MAD</p>
                  </div>
                </div>
              </div>
