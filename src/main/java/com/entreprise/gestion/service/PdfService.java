...
public class PdfService {
        ...
        try {
            ...
            if (facture.getDetails() != null) {
                for (FactureDetail detail : facture.getDetails()) {
                    ...
                    table.addCell(new Cell().add(new Paragraph(formatDecimal(detail.getPrixUnitaire()) + " €")));
                    table.addCell(new Cell().add(new Paragraph(formatDecimal(detail.getTauxTva()) + " %")));
                    table.addCell(new Cell().add(new Paragraph(formatDecimal(detail.getMontantHt()) + " €")));
                    table.addCell(new Cell().add(new Paragraph(formatDecimal(detail.getMontantTtc()) + " €")));
                }
            }
            ...
            // Totaux
            Paragraph totalHt = new Paragraph("Total HT: " + formatDecimal(facture.getMontantHt()) + " €")
                    .setTextAlignment(TextAlignment.RIGHT)
                    .setMarginTop(10);
            document.add(totalHt);
            
            Paragraph totalTva = new Paragraph("Total TVA: " + formatDecimal(facture.getMontantTva()) + " €")
                    .setTextAlignment(TextAlignment.RIGHT);
            document.add(totalTva);
            
            Paragraph totalTtc = new Paragraph("Total TTC: " + formatDecimal(facture.getMontantTtc()) + " €")
                    .setBold()
                    .setFontSize(16)
                    .setTextAlignment(TextAlignment.RIGHT)
                    .setMarginTop(5)
    ...
    public byte[] generateDevisPdf(Devis devis) {
        ...
        try {
            ...
            // Totaux
            Paragraph totalHt = new Paragraph("Total HT: " + formatDecimal(devis.getTotalHt()) + " €")
                    .setTextAlignment(TextAlignment.RIGHT)
                    .setMarginTop(10);
            document.add(totalHt);
            
            Paragraph totalTva = new Paragraph("Total TVA: " + formatDecimal(devis.getTotalTva()) + " €")
                    .setTextAlignment(TextAlignment.RIGHT);
            document.add(totalTva);
            
            Paragraph totalTtc = new Paragraph("Total TTC: " + formatDecimal(devis.getTotalTtc()) + " €")
                    .setBold()
                    .setFontSize(16)
                    .setTextAlignment(TextAlignment.RIGHT)
                    .setMarginTop(5)
